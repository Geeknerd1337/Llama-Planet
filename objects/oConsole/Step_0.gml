...
if console_submit(my_console) {
    ...
    *****************************/
    /*****************************
    * If use_r enters into the console:
    ...
    *****************************/
	if CMD("tplayer") {
		if instance_exists(oPlayer) {
			...
			console_print("No Player object to teleport.")
	...
	*/
	if console_cmd(my_console,"fullzoom") or console_cmd(my_console,"fulzoom") or console_cmd(my_console,"fz") {
	...
	if console_cmd(my_console,"gunlist") {
		...
		str = "------=====GUN LIST=====------"
		ds_list_insert(list,0,str)
		str = "use_ the shown commands to spawn the guns ( at mouse_ position )"
		ds_list_insert(list,0,str)
		llist = list;
		load_gun_stat(999)
	}
