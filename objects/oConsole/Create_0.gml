...
str = "type help if you don't know how to use_ me!"
ds_list_insert(my_console[? "history"],0,str);	

console_add(my_console,"tplayer"+s+"teleports the player to mouse position")
...
//console_add(my_console,"explode"+s+"-creates an explosion at mouse_ position");
...
console_add(my_console,"fullzoom aka fz"+s+"-Allows more zoom levels");
//console_add(my_console,"fz"+s+"-Allows more zoom levels");
